  ...
  <div class="modal fade" id="LIBRA" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">NYTRO LIBRA (IEC 60296, ED. 4) - STANDARD GRADE</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="MV3000" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">HanaSaki MV3000 4T Motorcycle Oil SAE 10W40 </h4>
        </div>
        <div class="modal-body">
